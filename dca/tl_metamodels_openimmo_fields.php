...
(
	...
	(
		'__selector__'                => array(''),
		'default'                     => 'name,metamodelAttribute;oiFieldGroup,oiField,oiCallback,oiCustomField;oiDefaultValue;oiConditionField,oiConditionValue;'
	),
	...
	(
        ...
        'oiCallback' => array
        (
            'label'					  => &$GLOBALS['TL_LANG']['tl_metamodels_openimmo_fields']['oiCallback'],
            'exclude'				  => true,
            'inputType'				  => 'text',
